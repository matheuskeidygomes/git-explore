...
Projeto criado utilizando a API pública do GitHub. Utilizada para recriar o meu perfil, junto às informações de visualização dos meus repositórios.
...
- [x] Listar dados de usuário e repositórios do github.
- [x] Adicionar e remover repositórios favoritos.

# Repositório Online

Acesse clicando no botão abaixo:   
  
<a href="https://github-explore-api.herokuapp.com/"> 
...
$ git clone <https://github.com/matheuskeidygomes/git-explore.git>
